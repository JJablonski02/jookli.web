    ...
    <footer className="mx-auto mt-12 w-full max-w-[1920px] px-20 md:px-5">
      <div className="w-full">
        ...
        <div className="mb-10 flex flex-row items-center justify-between gap-6 lg:flex-col lg:justify-evenly lg:gap-8">
          <FooterLinks />
          <Card className="flex w-2/5 flex-col rounded-3xl py-[44px] pl-[34px] pr-[54px] lg:w-full">
            <CardBody>
              <div>
                <p className="font-PoppinsSemiBold text-lg">
                  {t("downloadApp")}
                </p>
