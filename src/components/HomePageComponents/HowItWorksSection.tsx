  ...
  return (
    <section>
      <Squares position="left">
        <div className="flex w-full items-center justify-evenly gap-20 text-start lg:mx-0 lg:mt-10 md:flex md:flex-col">
          ...
          <div className="w-3/4">
            <div>
              ...
              <p className="mt-8 w-3/4 lg:mt-6">{t("paragraphDescription")}</p>
