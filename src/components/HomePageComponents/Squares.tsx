...
export const Squares: React.FC<ISquares> = ({
  ...
  square2Id
    ...
    const commonClasses = 'lg:hidden absolute h-[480px] aspect-square border-5 border-blue transform rotate-45 top-1/2 rounded-square z-[2] bg-secondary ';
    ...
    const commonChildrenClasses = "relative z-[3] w-[80%] lg:w-full flex min-h-[680px] lg:min-h-0 ";
