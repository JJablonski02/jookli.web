        ...
        <div className="embla__container">
          {WCSData.map((data, index) => (
             <div key={index} className="embla__slide">
              <div className="bg-white shadow-inner rounded-[1.8rem] min-w-0 p-8 h-[var(--slide-height)] select-none">              
                ...
                <Image src={user} alt={'user-svg'} className="w-14 h-14 lg:hidden" />
                  ...
                  <p className="text-secondary text-lg lg:text-sm line-clamp-6">
